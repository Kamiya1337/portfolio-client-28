    ...
    <div className="scrapbook-bg min-h-screen">
      ...
      <section className="px-5 pb-20 sm:px-8 xl:px-16">
        <div className="mx-auto max-w-[1200px]">
          <div className="flex flex-col gap-8 rounded-lg bg-obsidian p-8 text-white shadow-[0_4px_20px_rgba(53,42,56,0.05)] lg:flex-row lg:items-center lg:justify-between lg:p-12"><div><p className="dark-editorial-label">Rubric Criteria</p><h2 className="mt-4 font-display text-4xl font-semibold text-peach">Academic evaluation ledger</h2><div className="mt-6 h-1 w-20 rounded-full bg-peach/45" /></div><div className="rounded-lg border border-peach/25 bg-white/5 p-8 text-center"><p className="dark-editorial-label">Current Readiness</p><p className="mt-2 font-display text-6xl font-semibold text-peach">{progressPercent}%</p></div></div>
