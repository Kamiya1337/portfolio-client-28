  ...
  return (
    <div className="scrapbook-bg min-h-screen">
      ...
      <main className="mx-auto grid max-w-[1200px] gap-8 px-6 pb-28 sm:px-8 lg:grid-cols-12">
        ...
        <section className="mt-8 rounded-lg border border-border-light bg-mint p-8 text-charcoal shadow-[0_4px_20px_rgba(53,42,56,0.05)] sm:p-12 lg:col-span-12"><p className="editorial-label">Academic Integrity</p><h2 className="mt-4 font-display text-3xl font-semibold">Cam kết Liêm chính Học thuật</h2><p className="mt-7 whitespace-pre-line text-base italic leading-8 text-muted-dark">{`Em, Dương Thị Minh Hằng, cam kết rằng các báo cáo và nội dung trong portfolio này phản ánh đúng quá trình học tập và thực hành của bản thân. Trong quá trình làm, em có sử dụng AI như một công cụ hỗ trợ, chủ yếu để gợi ý cách trình bày, hỗ trợ sửa code và kiểm tra lại một số phần nội dung.
